...
def main(params):
    ...
    if params['small'] == 1:
        ...
        for i in range(len_):
            ...
            if i < len_*0.8:
                ...
                test.append({'ques_id': question_id,
                             ...
                             'question': question,
                             'answer': ans})
        print('Training sample %d, Testing sample %d...' % (len(train),
                                                            len(test)))
        ...
        for i in range(len(train_anno['annotations'])):
            ...
            image_path = imdir % (subtype,
                                  subtype,
                                  train_anno['annotations'][i]['image_id'])
        ...
        for i in range(len(val_anno['annotations'])):
            ...
            image_path = imdir % (subtype,
                                  subtype,
                                  val_anno['annotations'][i]['image_id'])
        ...
        for i in range(len(test_ques['questions'])):
            ...
            image_path = imdir % (subtype,
                                  subtype,
                                  test_ques['questions'][i]['image_id'])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--small", required=True, type=int,
                        help="1:only val for both train and test; 2: train on train and val test on test")
